...
export function LegalPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FAF8F5]">
            {/* Hero Section */}
            <section className="relative bg-white border-b border-[#E0D6CC] py-16">
            ...
            <nav className="max-w-7xl mx-auto px-4 py-6 text-xs font-sans-elegant uppercase tracking-wider">
                ...
                <span className="text-[#2C2420]">Legal</span>
            </nav>
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                    ...
                    <div id="privacy" className="space-y-8">
                        <div className="bg-white border border-[#E0D6CC] p-8 md:p-10">
                            ...
                            <div className="space-y-8">
                                <section>
                                    <h3 className="text-xs font-sans-elegant font-medium text-[#2C2420] mb-4 uppercase tracking-wider">
                                        1. Introducción
                                    </h3>
                                    <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed mb-4">
                                ...
                                <section>
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-3 text-sm">
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-5">
                                        <p className="font-sans-elegant font-medium text-[#2C2420] mb-3">✓ Medidas de Seguridad:</p>
                                        <ul className="space-y-2 text-[#7A6B5A] font-sans-elegant text-sm">
                                ...
                                <section>
                                    ...
                                    <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed mb-4">Tienes derecho a:</p>
                                    <ul className="space-y-2 text-[#7A6B5A] font-sans-elegant">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#2C2420]">•</span>
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-5">
                                        ...
                                        <p className="text-[#7A6B5A] font-sans-elegant text-sm mt-1">Email: privacy@pascalecloset.com</p>
                                    </div>
                                </section>
                            </div>
                        </div>
                        ...
                        <div className="bg-white border border-[#E0D6CC] p-8 md:p-10">
                            ...
                            <div className="space-y-8">
                                ...
                                <section>
                                    ...
                                    <ul className="space-y-2 text-[#7A6B5A] font-sans-elegant mb-4">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#2C2420]">✓</span>
                                    ...
                                    <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed mb-4">No puedes:</p>
                                    <ul className="space-y-2 text-[#7A6B5A] font-sans-elegant">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#2C2420]">✕</span>
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-5 space-y-4">
                                        <div>
                                            <p className="font-sans-elegant font-medium text-[#2C2420] mb-2">Como Compradora:</p>
                                            <ul className="space-y-1 text-[#7A6B5A] font-sans-elegant text-sm">
                                        ...
                                        <div>
                                            <p className="font-sans-elegant font-medium text-[#2C2420] mb-2">Como Vendedora:</p>
                                            <ul className="space-y-1 text-[#7A6B5A] font-sans-elegant text-sm">
                                ...
                                <section>
                                    ...
                                    <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed mb-4">Está prohibido:</p>
                                    <ul className="space-y-2 text-[#7A6B5A] font-sans-elegant">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#2C2420]">•</span>
                            ...
                            <div className="space-y-8">
                                ...
                                <section>
                                    ...
                                    <div className="space-y-4">
                                        <div className="border-l-2 border-[#2C2420] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies Esenciales</h4>
                                            <p className="text-[#7A6B5A] font-sans-elegant text-sm">Necesarias para el funcionamiento básico del sitio (autenticación, seguridad).</p>
                                            <p className="text-xs text-[#7A6B5A] font-sans-elegant mt-1">No se pueden desactivar en nuestros sistemas.</p>
                                        </div>
                                        <div className="border-l-2 border-[#7A6B5A] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies de Rendimiento</h4>
                                            <p className="text-[#7A6B5A] font-sans-elegant text-sm">Recopilan información sobre cómo usas el sitio (páginas visitadas, errores).</p>
                                            <p className="text-xs text-[#7A6B5A] font-sans-elegant mt-1">Nos ayudan a mejorar la plataforma.</p>
                                        </div>
                                        <div className="border-l-2 border-[#E0D6CC] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies de Funcionalidad</h4>
                                            <p className="text-[#7A6B5A] font-sans-elegant text-sm">Recuerdan tus preferencias y personalizaciones.</p>
                                            <p className="text-xs text-[#7A6B5A] font-sans-elegant mt-1">Ejemplo: idioma preferido, modo oscuro.</p>
                                        </div>
                                        <div className="border-l-2 border-[#C9B8A8] pl-4 py-2">
                                            ...
                                            <p className="text-[#7A6B5A] font-sans-elegant text-sm">Rastrean tu actividad para mostrar anuncios relevantes.</p>
                                            <p className="text-xs text-[#7A6B5A] font-sans-elegant mt-1">Se utilizan servicios de terceros como Google Analytics.</p>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-5 space-y-3">
                                        ...
                                        <div className="flex justify-between items-center py-2">
                                            <span className="font-sans-elegant font-medium text-[#2C2420]">Mercado Pago</span>
                ...
                {/* Final CTA */}
                <div className="mt-12 bg-[#2C2420] p-8 md:p-10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div className="flex gap-4 flex-wrap justify-center">
                            <Link 
                                to="/help" 
                                className="px-6 py-3 bg-white text-[#2C2420] font-sans-elegant text-xs tracking-wider uppercase hover:bg-[#F5F0EB] transition-all duration-200"
                            >
                                Centro de Ayuda
                            </Link>
                            <a 
                                href="mailto:legal@pascalecloset.com" 
                                className="px-6 py-3 border border-white text-white font-sans-elegant text-xs tracking-wider uppercase hover:bg-white hover:text-[#2C2420] transition-all duration-200"
                            >
                                Contactar
                            </a>
                        </div>
