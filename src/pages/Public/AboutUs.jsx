  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <nav className="max-w-7xl mx-auto px-4 py-6 text-xs font-sans-elegant uppercase tracking-wider">
        ...
        <span className="text-[#2C2420]">Nosotras</span>
      </nav>
        ...
        <div className="bg-white border border-[#E0D6CC] p-8 md:p-12">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed mb-4">
                <strong className="text-[#2C2420]">Pascale Closet</strong> nació de la pasión
              ...
              <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed">
                ...
                <a
                  ...
                  className="underline ml-1 text-[#2C2420]"
                >
                  Instagram
                </a>
                .
            ...
            <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-10 text-center">
              ...
              <h3 className="text-xl font-sans-elegant uppercase tracking-wider text-[#2C2420] mb-4">Nuestra Misión</h3>
              <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 pt-12 border-t border-[#E0D6CC]">
            <div className="text-center">
              <p className="text-4xl font-sans-elegant text-[#2C2420] mb-2">500+</p>
              <p className="text-xs text-[#7A6B5A] font-sans-elegant tracking-wider uppercase">Prendas exclusivas</p>
            </div>
            <div className="text-center">
              <p className="text-4xl font-sans-elegant text-[#2C2420] mb-2">2K+</p>
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-[#7A6B5A] font-sans-elegant tracking-wider uppercase">Satisfacción</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white border border-[#E0D6CC] p-8 text-center hover:shadow-lg transition-all duration-300">
            <div className="text-4xl mb-6">💎</div>
            <h3 className="text-lg font-sans-elegant uppercase tracking-wider text-[#2C2420] mb-4">Calidad</h3>
            <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed">
          ...
          <div className="bg-white border border-[#E0D6CC] p-8 text-center hover:shadow-lg transition-all duration-300">
            <div className="text-4xl mb-6">🤍</div>
            <h3 className="text-lg font-sans-elegant uppercase tracking-wider text-[#2C2420] mb-4">Confianza</h3>
            <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed">
          ...
          <div className="bg-white border border-[#E0D6CC] p-8 text-center hover:shadow-lg transition-all duration-300">
            <div className="text-4xl mb-6">✨</div>
            <h3 className="text-lg font-sans-elegant uppercase tracking-wider text-[#2C2420] mb-4">Elegancia</h3>
            <p className="text-[#7A6B5A] font-sans-elegant leading-relaxed">
      ...
      {/* CTA Final */}
      <section className="bg-[#2C2420] py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-sm text-[#7A6B5A] font-sans-elegant font-light mb-10 max-w-xl mx-auto">
            Date una vuelta por la tienda, seguro encontrarás esa prenda que
            querrás usar una y otra vez.
          </p>
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/products">
              <button className="px-10 py-4 bg-white text-[#2C2420] font-sans-elegant text-xs tracking-[0.2em] uppercase hover:bg-[#F5F0EB] transition-all duration-300">
                Explorar Colección
              </button>
            </Link>
            <Link to="/register">
              <button className="px-10 py-4 border border-white text-white font-sans-elegant text-xs tracking-[0.2em] uppercase hover:bg-white hover:text-[#2C2420] transition-all duration-300">
                Crear Cuenta
              </button>
            </Link>
          </div>
