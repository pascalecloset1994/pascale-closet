    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="faq" className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div
              key={i}
              className="bg-card border border-border p-6 hover:shadow-md transition-all duration-300"
            >
              <h3 className="font-sans-elegant text-sm uppercase tracking-wider text-foreground mb-3">{faq.q}</h3>
              <p className="text-muted-foreground font-sans-elegant leading-relaxed text-sm">{faq.a}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="shipping" className="max-w-7xl mx-auto px-4 py-12">
        <div className="bg-card border border-border p-8 md:p-12">
          ...
          <h2 className="text-2xl font-sans-elegant uppercase tracking-wider text-foreground mb-8">
            Información de Envío
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-sans-elegant font-medium text-foreground mb-4 tracking-wider uppercase text-xs">
                Tiempos de Entrega
              </h3>
              <table className="w-full border border-border">
                <thead className="bg-secondary">
                  <tr>
                    <th className="border border-border p-3 text-left font-sans-elegant text-xs uppercase tracking-wider text-foreground">Destino</th>
                    <th className="border border-border p-3 text-left font-sans-elegant text-xs uppercase tracking-wider text-foreground">Tiempo</th>
                  </tr>
                </thead>
                <tbody className="font-sans-elegant text-sm">
                  <tr>
                    <td className="border border-border p-3 text-muted-foreground">Chile</td>
                    <td className="border border-border p-3 text-foreground font-medium">5-7 días hábiles</td>
                  </tr>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="bg-secondary border border-border p-4">
                  <p className="font-sans-elegant font-medium text-foreground mb-1">✓ Envío Gratis</p>
                  <p className="text-sm text-muted-foreground font-sans-elegant">
                    En compras superiores a $60.000 dentro de Chile
                  </p>
                </div>
                <div className="border border-border p-4">
                  <p className="font-sans-elegant font-medium text-foreground mb-1">Envío Estándar</p>
                  <p className="text-sm text-muted-foreground font-sans-elegant">
                    $5.000 - $15.000 según peso y destino
                  </p>
                </div>
                <div className="border border-border p-4">
                  <p className="font-sans-elegant font-medium text-foreground mb-1">Envío Express</p>
                  <p className="text-sm text-muted-foreground font-sans-elegant">
          ...
          <div className="mt-8 bg-secondary border border-border p-4">
            <p className="text-sm text-muted-foreground font-sans-elegant">
              <span className="text-foreground font-medium">Nota:</span> La vendedora es responsable del envío. Los tiempos pueden variar según disponibilidad.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground font-sans-elegant leading-relaxed">
                ...
                Si no estás conforme, tienes <strong className="text-foreground">30 días</strong> desde la recepción 
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={step.num} className="border border-border p-4 text-center">
                    <div className="w-8 h-8 bg-foreground text-background flex items-center justify-center mx-auto mb-3 font-sans-elegant">
                      {step.num}
                    </div>
                    <p className="text-sm font-sans-elegant text-muted-foreground">{step.text}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-secondary border border-border p-4">
              <p className="font-sans-elegant font-medium text-foreground mb-2">Importante:</p>
              <ul className="text-sm text-muted-foreground font-sans-elegant space-y-1">
      ...
      <section id="contact" className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-card border border-border p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h3 className="font-sans-elegant font-medium text-foreground mb-6 tracking-wider uppercase text-xs">
                Información de Contacto
              </h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-secondary border border-border flex items-center justify-center text-foreground">
                    📍
                  </div>
                  <div>
                    <p className="font-sans-elegant font-medium text-foreground">Ubicación</p>
                    <p className="text-sm text-muted-foreground font-sans-elegant">
                      Santiago, Chile
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-sans-elegant font-medium text-foreground">Email</p>
                    <p className="text-sm text-muted-foreground font-sans-elegant">soporte@pascalecloset.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-secondary border border-border flex items-center justify-center text-foreground">
                  ...
                  <div>
                    <p className="font-sans-elegant font-medium text-foreground">Horario</p>
                    <p className="text-sm text-muted-foreground font-sans-elegant">
                      Lun-Vie: 10:00 - 18:00
                    </p>
                  </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              />
              <div className="mb-4">
                <label className="block text-xs font-sans-elegant font-medium mb-2 text-foreground uppercase tracking-wider">
                ...
                <textarea
                  ...
                  rows="4"
                  required
                  className="w-full px-4 py-3 border border-border bg-card font-sans-elegant text-foreground focus:border-foreground focus:ring-0 outline-none transition-all duration-200"
                ></textarea>
              </div>
              ...
              <div id='bottom' className="flex items-center justify-between gap-4 pt-4">
                ...
                <Link to="/products" className="text-xs text-muted-foreground hover:text-foreground font-sans-elegant uppercase tracking-wider transition-colors">
                  Volver a la tienda
                </Link>
              </div>
            </form>
